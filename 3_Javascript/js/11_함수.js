...
// 두개의 값을 전달받아 콘솔로 단순 출력하는 함수
function print1(num, str){  // 함수의 선언부
    // 함수의 정의
    console.log(`${num}은/는 ${str} 입니다.`)
}


// btn1 클릭 시 input1 의 값을 읽어와 print1() 함수 호출
...
// return 한 줄인데 object 타입 반환하는 경우
...
arrowList[3].addEventListener("click", () => {
    printObject((name, age) => {
        ...
        // {"name" : "홍길동", "age" : 20}
        // JS 객체 objec 타입! => return 한줄이어도 생략 불가
    });
