...
document.querySelector("#btn1").addEventListener("click", () => {
    ...
    const str2 = "jsp(java server page)도 곧 할겁니뎅";
    const str3 = "java, java, java";

    console.log(regExp1.test(str1)); // true
    console.log(regExp1.exec(str1));
    // ['script', index: 11, input: '저희는 지금 javascript를 공부하고 있읍니다', groups: undefined]
    

    console.log(regExp2.test(str2)); // true
    console.log(regExp2.exec(str2));
    // ['java', index: 4, input: 'jsp(java server page)도 곧 할겁니뎅', groups: undefined]

    console.log(regExp2.test(str3));
    console.log(regExp2.exec(str3)); // 처음 매칭되는 문자열을 반환
});
