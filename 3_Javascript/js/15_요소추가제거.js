...
addBtn.addEventListener("click", () => {
    ...
    // 클래스도 이렇게 추가할 수 있지만 보통은 클래스에 관련된 것들을 잘 처리할 수 있게 해주는 ClassList사용
    ...
    // 7. span 태그에 class "remove-row" 추가하기
